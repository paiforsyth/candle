...
python -m examples.lab --save_prefix=resnet164_basic_prune_06_retrain --resume_mode=standard --res_file=05_April_2018_Thursday_19_38_46resnet164_basic_prune_03_retrain_endofcycle_checkpoint_0
