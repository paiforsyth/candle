...
RESUME_FILENAME=06_April_2018_Friday_01_55_37resnet164_basic_prune_07_most_recent

SAVE_PREFIX=res_net_164_basic_prune_07_test
REPORT_FILENAME=./reports/res_net_basic_prune_07_test
