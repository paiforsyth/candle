RUNTYPE=group_prune_slow_adaptive
PTARG=30
NETTYPE=resnet29
LAMBDA=00001
ARGFILE=./sh/argfiles/${NETTYPE}_group
RESUME_FILENAME=10_April_2018_Tuesday_01_57_33resnet29_sensitivity_adaptive_group_prune_p30_lr05_test_fixedmaxpool_most_recent
