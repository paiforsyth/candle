RUNTYPE=group_prune_adaptive_slow
PTARG=05
NETTYPE=resnet29
LAMBDA=00001
ARGFILE=./sh/argfiles/${NETTYPE}_group
RESUME_FILENAME=10_April_2018_Tuesday_04_29_30resnet29_sensitivity_adaptive_group_prune_p1_lr05_test_fixedmaxpool_most_recent
