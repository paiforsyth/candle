...
python -m examples.lab $(cat $ARGFILE) --save_prefix=$SAVE_PREFIX --mode=test --resume_mode=standard  --res_file=${RESUME_FILENAME}  --use_val_as_test  --test_report_filename=$REPORT_FILENAME  --cuda
