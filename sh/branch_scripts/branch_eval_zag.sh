...
python -m examples.lab $(cat $ARGFILE)   --proxy_context_type=no_context  --save_prefix=$SAVE_PREFIX  --resume_mode=test  --use_val_as_test   --res_file=${RESUME_FILENAME}  --test_report_filename=branchy_thresh_$ENTROPY_THRESHOLD   --squeezenet_use_forking --squeezenet_fork_after_chunks 0 1  --squeezenet_num_layer_chunks=3 --squeezenet_use_non_default_layer_splits --squeezenet_layer_splits 0 3 12 --squeezenet_fork_early_exit   --squeezenet_fork_entropy_threshold $ENTROPY_THRESHOLD --cuda 
