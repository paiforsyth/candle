...
def default_parser(parser=None):
    ...
    parser.add_argument("--proxy_context_type", type=str, choices=["no_context","identity_context", "prune_context", "group_prune_context", "l0reg_context", "l1reg_context_slimming",  "tanhbinarize_context", "stdfactorize_context" ], default="no_context")
